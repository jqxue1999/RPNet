...
parser.add_argument('--model', type=str, default='eBaseNet', help='type of base model to use')
parser.add_argument('--model_ckpt', type=str, default='./checkpoint/', help='model checkpoint location')
...
checkpoint = torch.load(args.model_ckpt + args.model + '.pth')
